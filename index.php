        ...
        <div class="swiper swiper-container">
            ...
            while($row = mysqli_fetch_assoc($res))
            {
                ...
                <div class="swiper-slide">
                    <img src="$path$row[image]" class="w-100 d-clock" />
                </div>
                data;
            }          
            ...
            ?>
                ...
                <!-- this type of data we have take first for as duplicate  -->

                <!-- <div class="swiper-slide">
                    <img src="images/carousel/1.png" class="w-100 d-clock" />
                </div> -->
            ...
            <div class="swiper-wrapper mb-5">
                ...
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        ...
                        <h6 class="m-0 ms-2">Ragini Tai Joshi</h6>
                    </div>
                    <p>
                        Best Hotel Booking Website ever,the ui is very clean and convinent to use for any leyman.
                ...
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        <img src="images/features/star-fill.svg" width="30px">
                        <h6 class="m-0 ms-2">Gargiji Deshmukh</h6>
                    </div>
                    <p>Very clean and hygienic. Cozy and comfy experience with family. Great views from the terrace and
                        morning walks in the adjacent Gulab bagh
                    </p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
                ...
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        <img src="images/features/star-fill.svg" width="30px">
                        <h6 class="m-0 ms-2">Adityaji Chavan</h6>
                    </div>
                    <p>
                        Good Hotel but very expensive place.
